...
@section('content')
    ...
    <div class="bg-white dark:bg-ink-900 rounded-2xl shadow-soft border border-slate-100 dark:border-ink-800 overflow-hidden">
        <form method="GET" action="{{ route(request()->route()->getName()) }}"
            ...
            <div class="flex items-center gap-2 flex-1 min-w-[200px] max-w-[350px] bg-slate-50 dark:bg-ink-800 rounded-lg px-3 py-2">
            ...
            <table class="w-full">
                <thead class="bg-slate-50 dark:bg-ink-800">
                    <tr>
                        ...
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Overall Satisfy</th>
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Employee Behave</th>
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Resolving Customer’s concerns</th>
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Willingness To Help You</th>
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Employees Explain Information</th>
                        <th class="text-left font-medium text-xs text-slate-500 dark:text-ink-400 uppercase tracking-wider px-4 py-3">Rate Quality Service</th>
                    </tr>
                </thead>

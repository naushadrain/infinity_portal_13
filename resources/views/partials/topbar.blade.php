...
--}}
<header
    class="sticky top-0 z-30 h-16 bg-white/80 dark:bg-ink-900/80 backdrop-blur border-b border-slate-200 dark:border-ink-800 flex items-center px-4 lg:px-8 gap-3">

    {{-- Sidebar toggle (mobile + desktop) --}}
    <button onclick="toggleSidebar()" class="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-ink-800"
    ...
    <div class="relative" id="user-menu-wrap">
        ...
        <div id="user-dropdown"
            ...
            <div class="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100 dark:border-ink-800">
                <img src="{{ auth()->user()->profile_photo ? asset(auth()->user()->profile_photo) : asset('assets/user.png') }}"
            ...
            <div class="py-1">
                <a href="{{ route('profile') }}"
                    ...
                    <span
                        class="w-7 h-7 rounded-lg bg-brand-50 dark:bg-brand-900/30 flex items-center justify-center shrink-0">
            ...
            <div class="border-t border-slate-100 dark:border-ink-800 py-1">
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                        ...
                        <span
                            class="w-7 h-7 rounded-lg bg-rose-50 dark:bg-rose-900/20 flex items-center justify-center shrink-0">
